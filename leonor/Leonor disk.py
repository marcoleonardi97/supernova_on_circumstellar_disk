...
class BinaryDisk(object):
    def __init__(self, rin = 0.5 | units.au, rout = 3 | units.au, ndisk=1000, components = "all"):
        ...
        self.gravity.timestep_parameter=0.07|units.yr
    ...
    def bridge(self):
        ...
        gravhydro.timestep = 0.2*self.hydro.parameters.timestep
        return gravhydro
        return gravhydro
...
t_end = 10| units.yr
dt=1.0|units.yr
system.evolve(t_end,plot=True)
#system.evolve_without_bridge(dt,t_end, plot=True)
# ----------------------------
